...
@section('description', 'Editar stock')
...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('products.stocks.update', [$product, $stock]) }}" method="POST">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4">
                                <div class="form-group {{ $errors->has('purchase_amount') ? 'has-error' : '' }}">
                                    ...
                                    <input value="{{ old('purchase_amount', $stock->purchase_amount) }}" type="number" class="form-control" name="purchase_amount" id="purchase_amount" placeholder="Monto comprado">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="form-group {{ $errors->has('stock_min') ? 'has-error' : '' }}">
                                    ...
                                    <input value="{{ old('stock_min', $stock->stock_min) }}" type="number" class="form-control" name="stock_min" id="stock_min" placeholder="Stock mínimo">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="form-group {{ $errors->has('lot') ? 'has-error' : '' }}">
                                    ...
                                    <input value="{{ old('lot', $stock->lot) }}" type="number" class="form-control" name="lot" id="lot" placeholder="Número de lote">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group {{ $errors->has('due_date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input value="{{ old('due_date', $stock->due_date) }}" name="due_date" id="due_date" type="text" class="form-control pull-right">
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('provider_id') ? 'has-error' : '' }}">
                                    ...
                                    <select name="provider_id" id="provider_id" class="form-control select2" style="width: 100%;">
                                        ...
                                        @foreach($product->providers as $provider )
                                            <option value="{{ $provider->id }}" {{ old('provider_id', $stock->provider_id) == $provider->id ? 'selected' : '' }}>{{ $provider->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">Actualizar stock</button>
                            </div>
                        </div>
                    </div>
                </div>
